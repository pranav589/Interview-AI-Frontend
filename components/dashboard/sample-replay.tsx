               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                  ...
                  <div className="aspect-video bg-card border-2 border-primary/10 rounded-2xl flex flex-col items-center justify-center relative overflow-hidden group">
                     ...
                     <div className="absolute bottom-3 left-3">
                        <Badge className="bg-primary/10 backdrop-blur-md text-[10px] border-white/10 uppercase">AI Interviewer</Badge>
                     </div>
                  </div>

                  {/* Right side: User Camera Mockup */}
                  <div className="aspect-video bg-card border-2 border-emerald-500/10 rounded-2xl flex flex-col items-center justify-center relative overflow-hidden group">
                     <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/5 to-transparent opacity-50" />

                     {/* Simplified Avatar Animation */}
                     <div className="relative z-10 flex flex-col items-center">
                        <div className="w-20 h-20 rounded-full bg-emerald-500/10 flex items-center justify-center border-4 border-emerald-500/20 relative">
                        ...
                        <p className="mt-2 text-[10px] font-bold uppercase text-emerald-500 tracking-widest animate-pulse">Candidate Speaking...</p>
                     </div>

                     <div className="absolute bottom-3 left-3 flex items-center gap-2">
                        <Badge className="bg-emerald-500/10 backdrop-blur-md text-[10px] border-emerald-500/20 text-emerald-500 uppercase">Candidate (You)</Badge>
                        <div className="flex gap-1">
                           <div className="w-5 h-5 bg-emerald-500/10 rounded-full flex items-center justify-center border border-emerald-500/20"><Mic className="w-3 h-3 text-emerald-500" /></div>
                           <div className="w-5 h-5 bg-emerald-500/10 rounded-full flex items-center justify-center border border-emerald-500/20"><Video className="w-3 h-3 text-emerald-500" /></div>
                        </div>
                     </div>
                  </div>
               </div>
