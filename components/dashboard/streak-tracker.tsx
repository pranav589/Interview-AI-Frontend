...
export function StreakTracker({ streak, percentile }: StreakTrackerProps) {
  return (
          ...
          <div className="flex items-end gap-3">
             <div className="relative">
                <motion.div 
                   ...
                   className={`p-3 rounded-2xl ${streak > 0 ? 'bg-orange-500/10 text-orange-500' : 'bg-muted/10 text-muted-foreground'}`}
                >
                   <Flame className={streak > 0 ? "fill-orange-500" : ""} />
                </motion.div>
                {streak > 0 && (
             ...
             <div>
                <div className="text-4xl font-bold">{streak} {streak === 1 ? 'Day' : 'Days'}</div>
