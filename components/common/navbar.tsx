            ...
            {isLoggedIn ? (
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end" className="w-56">
                      ...
                      <DropdownMenuItem asChild>
                        <Link href="/dashboard/settings" className="cursor-pointer py-2.5">
                          <Settings className="mr-2 h-4 w-4" />
                          <span>Settings & Security</span>
                        </Link>
                      </DropdownMenuItem>
                      <DropdownMenuItem onClick={handleLogout} className="text-destructive focus:bg-destructive/10 focus:text-destructive py-2.5">
              ...
              <div className="flex items-center gap-2">
                ...
                <Link href="/auth/signup">
                  <Button size="sm" className="px-4 shadow-md shadow-primary/20">Get Started</Button>
                </Link>
              </div>
            )}
          </div>
