...
export default function InterviewDetailPage({
  ...
  const [activeJobId, setActiveJobId] = useState<string | null>(
    jobIdFromUrl || interview?.activeJobId || null,
  );

  const { data: job, isLoading: isJobLoading } = useInterviewJob(
              ...
              <Card className="max-w-2xl mx-auto border-dashed border-primary/20 bg-primary/5">
                <CardContent className="py-12 flex flex-col items-center text-center space-y-4">
                  ...
                  <CardDescription className="max-w-md text-base">
                    Our AI is currently reviewing your performance,
                    communication, and technical depth. This usually takes about
                    30-60 seconds.
                  </CardDescription>
            ...
            >
              <Card className="max-w-2xl mx-auto border-destructive/20 bg-destructive/5">
                <CardContent className="py-12 flex flex-col items-center text-center space-y-4">
                  ...
                  <CardDescription className="max-w-md text-base">
                    Something went wrong while generating your feedback. Please
                ...
                <div className="relative group">
                  ...
                  >
                    ...
                    <motion.circle
                      ...
                      style={{
                        filter:
                          "drop-shadow(0 0 8px oklch(0.6 0.25 270 / 0.3))",
                      }}
                    />
